...
public class Comment implements Persistable<Integer> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 194136220778218995L;
	...
	public Comment(String userName, String contents, String createdTime, int favouriteCount) {
	...
	public Comment(Integer id, String userName, String contents, String createdTime, int favouriteCount) {
