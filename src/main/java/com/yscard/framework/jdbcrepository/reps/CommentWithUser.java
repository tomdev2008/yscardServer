...
public class CommentWithUser extends Comment implements Persistable<Integer> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7543088432091360618L;
	private User user;

	public CommentWithUser(User user, String contents, String createdTime, int favouriteCount) {
		super(user.getUserName(), contents, createdTime, favouriteCount);
		this.user = user;
	}

	public CommentWithUser(Integer id, User user, String contents, String createdTime, int favouriteCount) {
